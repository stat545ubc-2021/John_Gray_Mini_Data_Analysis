...
## Exercise 2.1:
In this exercise, I fit a model that provides insight into the differences in the length to weight ratio amongst different species of fish captured at Bertrand and Pepin Creek. 
```{r}
