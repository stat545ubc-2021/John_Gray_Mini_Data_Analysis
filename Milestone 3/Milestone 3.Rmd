...
**Research Question**: How does the length to weight ratio differ between species in Pepin Creek and Bertrand Creek?
...
In this exercise I used a one-way ANOVA to assess whether the length to weight ratio differed significatnly among the fish species sampled. I stored the output of the ANOVA as a variable
